 ...
 * @author Abhay Goyal
 */
public class Finalshownotdetain extends javax.swing.JFrame {

    /**
     * Creates new form Finalshownotdetain
     */
    public Finalshownotdetain() {
        initComponents();
    }
    
    int val1;
     public Finalshownotdetain(int val)
    {
        initComponents();
        val1=val;
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            String s="Select subject1,subject2 from login where id="+val1+";";
           ...
           /* String s6="Select * from done order by desc;";
            ...
            //jTextField1.setText(subject1);
            //jTextField2.setText(subject2);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Finalshownotdetain.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Finalshownotdetain().setVisible(true);
            }
        });
    }
